...
class SuggestionsListFragment:BaseFragment(), NewVideoPresenter.SearchMvp, ListItemListener, LoadMoreListener {
    ...
    override fun initView() {
        ...
        swipeRefreshLayout.setOnRefreshListener(object : SwipeRefreshLayout.OnRefreshListener {
            override fun onRefresh() {
                ...
                adapter.loadMore(list,false, this@SuggestionsListFragment)
                adapter.notifyDataSetChanged()
                presenter.nextPageToken = ""
                offset =0
                presenter.suggestionList(0,false)
            }
