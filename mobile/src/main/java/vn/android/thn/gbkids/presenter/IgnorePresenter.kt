...
import vn.android.thn.gbkids.views.fragment.IgnoreFragment
import vn.android.thn.gbkids.views.fragment.LikeFragment
import vn.android.thn.gbkids.views.fragment.WatchedFragment

class IgnorePresenter(view: IgnoreFragment, mActivity: FragmentActivity?) :
    PresenterBase<IgnoreFragment>(view, mActivity) , LoadMoreListener {
